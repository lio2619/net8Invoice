...
{
    public partial class GuanmaoNewForm : Form
    {
        private readonly IPdfImportService _pdfImportService;
        public GuanmaoNewForm(IPdfImportService pdfImportService)
        {
            InitializeComponent();
        ...
        private async void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var results = await _pdfImportService.ImportFromPdfNewAsync(dialog.FileName);
